# This image tests the installation on Debian bookworm (old stable)
...
RUN apt-get update \
    && apt-get install -y \
        ...
        ruby ruby-dev libsqlite3-dev libssl-dev pkg-config cmake libssh2-1-dev libicu-dev zlib1g-dev g++ libyaml-dev \
    && apt-get clean \
